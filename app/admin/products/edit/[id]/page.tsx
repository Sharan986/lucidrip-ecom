    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setStatus(data.stock > 0 ? "Active" : "Draft");
        } else {
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-extralight text-neutral-900">
              <span className="italic">Edit Product</span>
            </h1>
          </div>
        </div>
        <button
          ...
          className="px-4 py-2.5 border border-red-200 text-red-600 text-xs tracking-[0.1em] uppercase hover:bg-red-50 transition flex items-center gap-2"
        >
